function check(){
    ...
    let arrayOfColors = colors[randomNum];
    console.log(arrayOfColors);
    document.getElementById('body').style.backgroundColor = arrayOfColors;
    document.getElementById('color').textContent = arrayOfColors;
}
